          ...
          <div className="mx-auto w-full max-w-md">
            ...
            <div className="mb-6 grid grid-cols-2 gap-3">
              ...
              <button
                ...
                className={`flex flex-col items-start gap-1.5 cursor-pointer rounded-2xl border p-4 text-left transition ${role === 'provider'
                  ? 'border-brand-indigo bg-brand-indigo/5 ring-2 ring-brand-indigo/20'
                  : 'border-brand-ink/10 bg-white hover:border-brand-ink/20'
                  }`}
              >
            ...
            <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div className="flex flex-col gap-1.5">
                  <label htmlFor='phone' className="text-xs font-semibold tracking-wide text-brand-ink/70">
                    PHONE NUMBER
                  </label>
                  <div className="relative flex items-center">
              ...
              {/* Password */}
              <div className="flex flex-col gap-1.5">
                <label htmlFor='pass' className="text-xs font-semibold tracking-wide text-brand-ink/70">
                  PASSWORD
                </label>
                <div className="relative flex items-center">
              ...
              {role === 'provider' && (
                <div className="mt-1 space-y-4 rounded-2xl border border-brand-marigold/30 bg-brand-marigold/5 p-4">
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label htmlFor='location' className="text-xs font-semibold text-brand-ink/70">
                        LOCATION / AREA
                      </label>
                      <div className="relative flex items-center">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label htmlFor='price' className="text-xs font-semibold text-brand-ink/70">
                        STARTING PRICE (RS)
                      </label>
                      <div className="relative flex items-center">
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label htmlFor='bio' className="text-xs font-semibold text-brand-ink/70">
                      SHORT BIO
                    </label>
              ...
              <button
                type="submit"
                disabled={submitting}
                className="group mt-1 flex w-full items-center justify-center gap-2 rounded-xl bg-brand-ink py-3 text-sm font-semibold text-white shadow-lg shadow-brand-ink/10 transition hover:bg-brand-indigo hover:shadow-brand-indigo/20 disabled:cursor-not-allowed disabled:opacity-60 cursor-pointer"
              >
                {submitting ? (
                  <>

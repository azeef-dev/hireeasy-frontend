    ...
    <div className="mx-auto flex min-h-[calc(100vh-5rem)] max-w-6xl items-center justify-center px-4 py-8 sm:px-6 lg:px-8">
      <div className="grid w-full overflow-hidden rounded-3xl bg-white shadow-[0_20px_50px_rgba(23,25,51,0.08)] lg:grid-cols-12">
        ...
        <div className="relative hidden flex-col justify-between overflow-hidden bg-brand-indigo p-10 text-white lg:col-span-5 lg:flex">
          ...
          {/* Perks list */}
          <div className="relative z-10 space-y-3 rounded-2xl bg-white/10 p-5 backdrop-blur-md">
        ...
        {/* ── Right Form Panel ── */}
        <div className="flex flex-col justify-center px-6 py-10 sm:px-12 lg:col-span-7 lg:py-14">
          <div className="mx-auto w-full max-w-lg">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="relative flex items-center">
                    <User size={18} className="pointer-events-none absolute left-3.5 text-brand-ink/35" />
                    <input
                      required
                      value={form.name}
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="relative flex items-center">
                    <Phone size={18} className="pointer-events-none absolute left-3.5 text-brand-ink/35" />
                    <input
                      value={form.phone}
              ...
              {role === 'provider' && (
                <div className="mt-2 space-y-4 rounded-2xl border border-brand-marigold/30 bg-brand-marigold/5 p-4 sm:p-5">
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div className="flex flex-col gap-1.5">
                      ...
                      <div className="relative flex items-center">
                        <MapPin size={16} className="pointer-events-none absolute left-3 text-brand-ink/35" />
                        <input
                          value={form.location}
                          onChange={update('location')}
                          className="w-full rounded-xl border border-brand-ink/10 bg-white py-2.5 pl-9 pr-3 text-sm text-brand-ink placeholder:text-brand-ink/35 focus:outline-none focus:ring-2 focus:ring-brand-marigold"
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="flex flex-col gap-1.5">
                      ...
                      <div className="relative flex items-center">
                        <Clock size={16} className="pointer-events-none absolute left-3 text-brand-ink/35" />
                        <input
                          type="number"
                          min="0"
                    ...
                    <div className="flex flex-col gap-1.5">
                      ...
                      <div className="relative flex items-center">
                        <DollarSign size={16} className="pointer-events-none absolute left-3 text-brand-ink/35" />
                        <input
                          type="number"
                          min="0"
                          value={form.price}
              ...
              <button
                type="submit"
                disabled={submitting}
                className="group mt-2 flex w-full items-center justify-center gap-2 rounded-xl bg-brand-ink py-3.5 text-sm font-semibold text-white shadow-lg shadow-brand-ink/10 transition hover:bg-brand-indigo hover:shadow-brand-indigo/20 disabled:cursor-not-allowed disabled:opacity-60"
              >
                {submitting ? (
                  <>
